...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const messages = [
    ...
    },
    {
      speaker: "boss",
      name: "社長",
      text: "正直なところ、観光業を始めた理由は、市場のポテンシャルを感じたからです。日本は世界的に有名な観光大国であり、毎年多くの観光客を魅了しています。富士山、京都、温泉、伝統工芸など、どの地域にも独自の魅力があります。その中、観光客数が増加している一方で、旅行サービスの質や体験にはまだ改善の余地があると感じました。私は25歳になる前に日本を旅行で何度も訪れ、日本の観光地や文化の素晴らしさを深く感じました。私はこの機会を活かし、より高品質で個別化されたサービスを提供し、運営効率を向上させることで、この業界で持続的な成長と利益を得られると考えました。Gogoday旅行会社を創業した目的は、優れたサービスを提供するだけでなく、規模を拡大して、会社が長期的に収益を上げられるシステムを形成するためです。また、旅行を通じてお客様に幸せな体験を提供するし、地域経済の発展に貢献することで、私にとって大きく達成感をもたらしてくれます。",
